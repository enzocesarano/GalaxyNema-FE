...
const MyNav = ({ isAuthenticated, onLoginSuccess, onLogout }) => {
  ...
  return (
    <Navbar
      expand="xl"
      className="d-flex flex-row flex-xl-column h100-1200 p-0 justify-content-between"
    >
      <div className="w-100">
        <div className="w-100 mb-5 text-center d-none d-xl-block">
          <img
            src="/logo.svg"
            alt="Galaxynema Logo"
        ...
        <div
          className={`m-xl-0 w-50 xl-100 m-auto mt-4 mt-xl-4 ${
